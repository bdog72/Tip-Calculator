...
(function () {
  ...
  var users = document.getElementById('input-users');
  var service = document.getElementById('input-service'); // customer feedback

  var feedback = document.querySelector('.feedback');
  var loader = document.querySelector('.loader');
  var results = document.querySelector('.results'); // submit form

  form.addEventListener('submit', function (e) {
    e.preventDefault();
    var bill = amount.value;
    var people = users.value;
    var quality = service.value; // console.log(bill);
    // console.log(people);
    // console.log(quality);
  ...
  function showResults(bill, people, quality) {
    ...
    var tipAmount = parseInt(bill) * percent;
    var total = parseInt(bill) + tipAmount;
    var person = total / parseInt(people);
...
//# sourceMappingURL=/Tip%20Calculator.e31bb0bc.map